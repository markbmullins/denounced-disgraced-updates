...
export const OrderTemplate = ({ lineItems = [{title:"test",image:"/",amount:"20$",quantity:2}],shippingAddress ="America",orderId = '123' }: { lineItems: { title: string, image: string, amount: string, quantity: number }[],shippingAddress:string,orderId:string, }) => {
          ...
          <Section style={global.defaultPadding}>
            <Row style={{ display: 'inline-flex', marginBottom: 40 }}>
              ...
              <Column>
                ...
                <Text style={track.number}>{new Date().toISOString() }</Text>
              </Column>
            </Row>
